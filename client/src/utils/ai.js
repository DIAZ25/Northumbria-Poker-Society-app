/**
 * 
 * 	Main functions to handle the bots 
 * 	Their actions are determined based on the cards they hold
...
const handleAI = (state, pushAnimationState) => {
	...
	switch(state.phase) {
		...
		case('betting2'): // no need
		case('betting3'): // no need
		case('betting4'):
			const { 
			...
			const { 
				...
				isStraight, 
				//isLowStraight, // TODO
				//concurrentCardValues, // TODO
				//concurrentCardValuesLow, // TODO
			...
			const { 
				...
				isStraightFlush, 
				//isLowStraightFlush, // TODO
				//concurrentSFCardValues, // TODO
				//concurrentSFCardValuesLow, // TODO 
